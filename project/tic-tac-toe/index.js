...
$(document).ready(function() {
    ...
    function isWin() {
        for (var i = 0; i < 3; i++) {
            if (
                data.board[i * 3] !== undefined &&
                data.board[i * 3] == data.board[i * 3 + 1] &&
        ...
        if (
            data.board[0] !== undefined &&
            data.board[0] == data.board[4] &&
        ...
        if (
            data.board[2] !== undefined &&
            data.board[2] == data.board[4] &&
